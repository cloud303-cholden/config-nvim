...
M.load = function()
  ...
  vim.cmd("hi InsertCursor guibg=#d08770")
  vim.cmd("hi NormalCursor guibg=#81a1c1")
  ...
  vim.cmd("hi MatchParen guifg=#191d24 guibg=#81a1c1 gui=none")
  ...
  vim.cmd("hi SpecialCmpBorder guibg=none")
  vim.cmd("hi WildMenu guibg=none")
  vim.cmd("hi NvimTreeFolderIcon guifg=#b1c89d")
  vim.cmd("hi NvimTreeFolderName guifg=#b1c89d gui=bold")

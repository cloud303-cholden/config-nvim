    ...
    require("rust-tools").setup {
      ...
      server = {
        ...
        settings = {
          ["rust-analyzer"] = {
            -- server = {
            --   path = "/home/ch/.cargo/bin/ra-multiplex",
            -- },
            lens = {
              enable = true,
            },
      ...
      --     "/home/ch/downloads/lldb/extension/adapter/codelldb",
      --     "/home/ch/downloads/lldb/extension/lldb/lib/liblldb.so"
      --   )
      -- }
      -- dap = dap
      dap = {
        adapter = {
          ...
          host = "127.0.0.1",
          executable = {
            command = "/home/ch/downloads/lldb/extension/adapter/codelldb",
            args = { "--liblldb", "/home/ch/downloads/lldb/extension/lldb/lib/liblldb.so", "--port", "34567" },
          },
        }
      }
    }
